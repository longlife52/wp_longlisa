          ...
          <section class="billboard_blue_wrapper offering_wrapper">
              <div class="billboard center_text offering_billboard title_space title_nospace">
                  <div class="title_line">
                      <h2 class="offering_title_small">learn about</h2>
                  </div>
                  <h2 class="offering_title_big title_uppercase title_size_increase"><?php _e( '', 'html5blank' ); single_tag_title('', true); ?></h2>
                  <div class="billboard_para">
                      <p>Dive deep into these articles that I wrote and curated especially for you to help you better understand the how, the why, and the when.</p>
                  </div>
              </div>
